                    ...
                    {members.map((m) => (
                        ...
                        >
                            <Avatar className="h-6 w-6">
                                {m.avatarUrl ? ( <AvatarImage src={`https://localhost:7233${m.avatarUrl}`} alt={m.fullName} />) : (<AvatarFallback className="text-xs bg-slate-700 text-white">{m.fullName?.charAt(0).toUpperCase() || '?'}</AvatarFallback>)}
                            </Avatar>
